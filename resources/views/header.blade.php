 <div class="row" id="head_menu">
            <img src="source/img/img_index/logo2.png" id="logo" alt="logo" class="animated inifinite bounceInLeft">
            ...
            <ul  id="menu_head">
              ...
              <li>
                ...
                @else
               <img src="source/img/img_dai_dien/{{ Auth::user()->image }}" style="width: 30px;height: 30px;border-radius: 180px">
                @endif
                    ...
                    <a href="" title="" class="dropdown-toggle" data-toggle="dropdown"><i class="fas fa-chevron-down"></i></a>
                     <div class="dropdown-menu">
                       <ul style="margin-right: 30px;margin-top:10px">
                           <a href="suatk/{{ Auth::user()->id }}" title=""><li style="margin-top:-20px;margin-left:-70px">Sửa thông tin</li></a>
               ...
               @else
                ...
                @endif
               {{--  <a href="{{ route('tin-tuc') }}" title="">
                    <li class="li">TIN TỨC</li>
                </a> --}}
              {{--   <a href="{{ route('getlienhe') }}" title="">
                    <li>LIÊN HỆ</li>
                </a>
                --}}
                   <li class="li">
                     ...
                     &nbsp;</span>
                      {{-- <ul class="dropdown-menu">
                        <div class="col-md-12" style="width: 300px;">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <img src="source/img/img_sp/{{ $pro['item']['image'] }}" alt="" style="width: 100px;height: 100px">
                                </div>
