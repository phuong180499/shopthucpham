        ...
        <div class="col-md-offset-4 col-md-4" style="margin-bottom: 100px">
            ...
            <form action="{{ route('dang-nhap') }}" method="post">
                ...
                <div class="form-group has-feedback has-feedback-left">
                    <label class="red">*</label><input type="text" class="form-control" name="email" required value="doanlinh1098@gmail.com">
                    <div class="form-control-feedback">
                        <i class="icon-user text-muted"></i>
                    </div>
                </div>
                <div class="form-group has-feedback has-feedback-left">
                    <label class="red">*</label><input type="password" class="form-control" required name="password" placeholder="Password" value="linh19982591">
                    <div class="form-control-feedback">
